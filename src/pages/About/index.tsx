...
export function About() {
  useEffect(() => {
    document.title = 'Entenda pomodora';
  }, []);
  return (
    <MainTemplate>
      <GenericHtml>
        ...
        <p>
          ...
          <strong>Francesco Cirillo</strong>, que consiste em dividir o trabalho em blocos de
          tempo (os famosos "Pomodoros") intercalados com pausas. O objetivo é manter o foco
          total por um período curto e garantir descansos para evitar o cansaço mental.
        </p>
        ...
        <ul>
          ...
          <li>
            <strong>4. A cada 4 ciclos, faça uma pausa longa</strong> (geralmente 15 a 30
            minutos).
          </li>
        </ul>
        ...
        <p>
          Nosso app segue o conceito original, mas com algumas melhorias e personalizações pra
          deixar o processo ainda mais eficiente:
        </p>

        <h3>⚙️ Personalização do tempo</h3>
        <p>
          Você pode configurar o tempo de foco, descanso curto e descanso longo do jeito que
          quiser! Basta acessar a{' '}
          <RouterLink href="/settings">página de configurações</RouterLink> e ajustar os
          minutos como preferir.
        </p>

        <h3>🔁 Ciclos organizados em sequência</h3>
        <p>
          A cada ciclo completado, uma nova task é adicionada automaticamente ao seu histórico,
          e o app já sugere o próximo ciclo (foco ou descanso).
        </p>
        <p>
        ...
        <p>
          Assim, você sempre sabe em que parte do processo está e o que vem a seguir. Não
          precisa mais anotar no papel ou ficar calculando de cabeça!
        </p>
        ...
        <p>
          ...
          interrompidas. Assim, você consegue acompanhar sua evolução ao longo do tempo.
        </p>
